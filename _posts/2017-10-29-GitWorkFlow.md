...
그럼 어떤 사람들이 그런 생각을 하게 만들까 고민 해보면, 배울점이 있는분(포괄적인 의미에서), 열정적이고, 무언가를 시작하면 즐기는분...등등 이유는 많이 있는것 같습니다. 본질적으로 함께 무언가를 했을때, 상대방을 즐겁게 해준다면 진짜 좋은 개발자가 아닐까...하고 그냥 찌끄려봅니다..
...
#### [Git 명령어 모음](https://medium.com/@joongwon/git-git-명령어-정리-c25b421ecdbd)
